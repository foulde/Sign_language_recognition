...
class SIGN_dataset(Dataset):
    def __init__(self, pose_root, sample_strategy='seq', num_samples=50, num_copies=4,
                 img_transforms=None, video_transforms=None , FACE=False):
        self.data = []
...
#function Currently used for smapling video 
...
if __name__ == '__main__':
    ...
    train_dataset = SIGN_dataset(split=['train'], pose_root="video__landmarks",img_transforms=None, video_transforms=None, num_samples= 50)
